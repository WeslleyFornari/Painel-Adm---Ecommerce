...
<div class="row mt-5 mb-1" style="margin-left:1px;">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Cupons</p>
                    <h5 class="font-weight-bolder mb-0">
                     {{$cupons}}
                      <span class="text-success text-sm font-weight-bolder"></span>
                    </h5>
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-light shadow text-center border-radius-md">
                    <i class="fas fa-receipt" style="font-size:25px;" aria-hidden="true"></i>
                  </div>
                </div>
              </div>
            </div>
