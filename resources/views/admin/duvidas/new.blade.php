...
<form id="formStore" action="{{route('admin.duvidas.store')}}" method="POST" enctype="multipart/form-data">
@csrf
             ...
             <div class="card-body">
                ...
                <div class="row">
                    ...
                    <!-- CONTEUDO SUMMER NOTE -->
                        <div class="col-12">                               
                                <textarea id="summernote" name="resposta" class="form-control"  placeholder="Digite sua resposta" style="display: block;"></textarea>
                        </div>
