    ...
    <div class="page">
        ...
        <div class="mt-2">
            ...
            @foreach ($pedido->itens as $item)
                ...
                <table style="width:100%; border-collapse:collapse; border: 1px solid rgba(0, 0, 0, .125); border-top: none">
                    <tbody>
                        <tr style="border-top: none; border-bottom: 1px solid rgba(0, 0, 0, .125);">
                            <td style="border-right: 1px solid rgba(0, 0, 0, .125); padding:4px; width: 16%;">Entrega</td>
        ...
        <div class="mt-2">
            <table style="width:100%; border-collapse:collapse; border: 1px solid rgba(0, 0, 0, .125);">
                <thead>
                    <tr style="border-bottom: 1px solid rgba(0, 0, 0, .125);">
                        <th style="border-right: 1px solid rgba(0, 0, 0, .125); padding:4px; text-align: left; width: 41%;"><strong>Item</strong></th>
                        <th style="border-right: 1px solid rgba(0, 0, 0, .125); padding:4px; text-align: left"><strong>Qtd</strong></th>
                        ...
                        <th style="padding:4px;"><strong>Entregue</strong></th>
                    </tr>
                </thead>
                <tbody>
                @foreach ($pedido->itens as $item)
                ...
                @endforeach
                    <tr style="border-top: none; border-bottom: 1px solid rgba(0, 0, 0, .125);">
                        <td style="border-right: 1px solid rgba(0, 0, 0, .125); padding:4px; text-align:right; width: 41%;"><strong>QTD TOTAL DE ITENS</strong></td>
        ...
        <div class="mt-2">
            <table style="width:100%; border-collapse:collapse; border: 1px solid rgba(0, 0, 0, .125);">
                <thead>
                    <tr style="border-bottom: 1px solid rgba(0, 0, 0, .125);">
                        <th style="text-align:center; padding:4px;"><strong>Observações e Ocorrências Identificadas na Entrega para o Cliente</strong></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
        ...
        <div class="mt-2 entrega px-0" style="width: 60%">
            <table style="width:100%; border-collapse:collapse; border: 1px solid rgba(0, 0, 0, .125);">
                <thead>
                    <tr style="border-bottom: 1px solid rgba(0, 0, 0, .125);">
