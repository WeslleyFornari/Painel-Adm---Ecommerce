...
<form id="formStore" action="{{route('admin.produtos_categorias.update', $produto_categoria->id) }}" enctype="multipart/form-data">
@csrf
                ...
                <div class="row mb-4 border-bottom">
                    ...
                    <div class="row ms-5 arial14-font mb-4">
                        ...
                        <div class="col-6 pe-5">
                            <input type="hidden" name="id" value="{{$produto_categoria->id}}">
                            
                            <div class="form-group">
                                <span class="titulo"> Nome: *</span>
                                <input type="text" name="nome" value="{{$produto_categoria->nome}}" class="form-control" required>  
                            </div>
                            <div class="form-group">
                                <span class="titulo"> Tipo:</span>
                                <select class="form-select" name="tipo" id="tipo">
                                    <option value="trip" selected @if($produto_categoria?->tipo == 'trip') selected @endif>Trip</option>
                                    <option value="toy" @if($produto_categoria?->tipo == 'toy') selected @endif>Toy</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <span class="titulo"> Descriçao: *</span>
                                <input type="text" name="descricao" value="{{$produto_categoria->descricao}}" class="form-control" required>  
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-6 ps-5">
                            <div class="form-group">
                                ...
                                <x-upload-file target="logo" collum="id_media" type="single" :media="$produto_categoria"/>
                            </div>
                        </div>
