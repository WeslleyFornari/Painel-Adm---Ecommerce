...
<div class="col-12 text-end">
    <a href="{{route('admin.produtos.catalogo.index')}}" class="text-decoration-underline" style="font-size: 1.2rem;">Produtos Catálogo</a>
</div>
@endif
<div class="col-12">
...
<div class="col-12 mt-4">
    ...
    <div class="row m-0 py-2 border-bottom arial14-font-normal ">
        ...
        @if(permissao('produtos')->editar == 'sim')
            <a href="{{route('admin.produtos.edit', $prod->id)}}" class="btn btn-icon-only btn-secondary edit"> <i class="fas fa-pencil"></i> </a>
        @endif
        @if(permissao('depoimentos')->deletar == 'sim')
            <a href="{{route('admin.produtos.delete', $prod->id)}}" class="btn btn-icon-only btn-danger btn-exclude"> <i class="fas fa-trash"></i> </a>
        @endif
        </div>
    </div>
    @endforeach
